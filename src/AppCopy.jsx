...
import OrderDetailsPage from "./components/Sales Executive/Order Create/OrderDetailsPage";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/admin/users"
            element={
              <PrivateRoute allowedRoles={["admin"]} element={<UserPage />} />
            }
          />
          ...
          <Route
            path="/admin/*"
            element={
              <PrivateRoute allowedRoles={["admin"]} element={<Layout />} />
            }
          >
            <Route path="supplier" element={<SuppliersTable />} />
            <Route
              path="warehouse-inventory"
              element={<WarehouseInventoryTable />}
            />
          </Route>
          ...
          >
            ...
            />
            <Route
              path="material-inward/:grnId"
              element={<MaterialInwardRegister />}
            />
            <Route
              path="purchase-order/:referenceNo"
          ...
          <Route
            path="/sales-executive/items-master"
            element={
              <PrivateRoute
                allowedRoles={["sales executive"]}
